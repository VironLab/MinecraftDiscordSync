...
public class PlayerListCommand extends DiscordCommand {
	...
	public boolean execute(CommandData data) {
		...
		embedBuilder.setTitle(BungeeMinecraftDiscordSync.getInstance().getPluginMessages().translate("command.discord.playerlist.title", String.valueOf(BungeeServerUtil.getPlayerCount()), String.valueOf(BungeeServerUtil.getMaxPlayerCount())));
		embedBuilder.setColor(0x00ff00);
		String pl = BungeeServerUtil.getPlayerList();
		if(pl == "") pl = BungeeMinecraftDiscordSync.getInstance().getPluginMessages().translate("command.discord.playerlist.noplayers");
