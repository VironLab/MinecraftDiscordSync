...
public class OnlineCommand extends DiscordCommand {
	...
	public boolean execute(CommandData data) {
		...
		embedBuilder.setTitle(BungeeMinecraftDiscordSync.getInstance().getPluginMessages().translate("command.discord.online.title", String.valueOf(BungeeServerUtil.getPlayerCount()), String.valueOf(BungeeServerUtil.getMaxPlayerCount())));
