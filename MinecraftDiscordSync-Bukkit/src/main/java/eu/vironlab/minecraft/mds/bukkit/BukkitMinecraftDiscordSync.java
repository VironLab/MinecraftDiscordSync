...
package eu.vironlab.minecraft.mds.bukkit;
...
import eu.vironlab.minecraft.mds.bukkit.bot.DiscordSyncBot;
import eu.vironlab.minecraft.mds.bukkit.commands.DiscordCommand;
import eu.vironlab.minecraft.mds.bukkit.commands.DiscordServerInfoCommand;
import eu.vironlab.minecraft.mds.bukkit.commands.VerifyCommand;
import eu.vironlab.minecraft.mds.bukkit.listener.*;
import eu.vironlab.minecraft.mds.bukkit.logging.PluginLogger;
import eu.vironlab.minecraft.mds.bukkit.permissions.LuckPermsPermissionHandler;
import eu.vironlab.minecraft.mds.bukkit.permissions.VaultPermissionHandler;
import eu.vironlab.minecraft.mds.bukkit.storage.YAMLStorage;
import eu.vironlab.minecraft.mds.bukkit.verification.BukkitDiscordVerifier;

public class BukkitMinecraftDiscordSync extends JavaPlugin {
	
	private static BukkitMinecraftDiscordSync instance;
	public static BukkitMinecraftDiscordSync getInstance() {
		return instance;
	}
	...
	public void onEnable() {
		...
		try {
			...
			case "vault":
				permissionProvider = new VaultPermissionHandler();
				break;
			default:
		...
		verificationProvider = new BukkitDiscordVerifier();
	...
	private void registerCommands() {
		if(this.getConfig().getBoolean("plugin.commands_enabled.ingame.discordinfo", false)) {
			this.getCommand("discordinfo").setExecutor(new DiscordServerInfoCommand());
			this.getCommand("dcinfo").setExecutor(new DiscordServerInfoCommand());
		}
