...
public class OnlineCommand extends DiscordCommand {
	...
	public boolean execute(CommandData data) {
		...
		embedBuilder.setTitle(BukkitMinecraftDiscordSync.getInstance().getPluginMessages().translate("command.discord.online.title", String.valueOf(BukkitServerUtil.getPlayerCount()), String.valueOf(BukkitServerUtil.getMaxPlayerCount())));
