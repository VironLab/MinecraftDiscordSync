...
package eu.vironlab.minecraft.mds.bukkit.bot;

import java.util.ArrayList;
import java.util.List;

import eu.vironlab.minecraft.mds.bukkit.BukkitMinecraftDiscordSync;
import eu.vironlab.minecraft.mds.bukkit.bot.commands.*;
import eu.vironlab.minecraft.mds.bukkit.bot.listener.*;
...
public class DiscordSyncBot extends DiscordBot {
	...
	public DiscordSyncBot(IPluginLogger pluginLogger, String token, String commandPrefix) {
		...
		if(BukkitMinecraftDiscordSync.getInstance().getConfig().getBoolean("plugin.commands_enabled.discord.online", false))
			defaultCommands.add(new OnlineCommand());
		if(BukkitMinecraftDiscordSync.getInstance().getConfig().getBoolean("plugin.commands_enabled.discord.playerlist", false))
			defaultCommands.add(new PlayerListCommand());
		if(BukkitMinecraftDiscordSync.getInstance().getConfig().getBoolean("plugin.commands_enabled.discord.serverinfo", false))
			defaultCommands.add(new ServerInfoCommand());	
		if(BukkitMinecraftDiscordSync.getInstance().getConfig().getBoolean("plugin.commands_enabled.discord.verify", false))
