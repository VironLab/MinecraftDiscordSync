...
public class PlayerListCommand extends DiscordCommand {
	...
	public boolean execute(CommandData data) {
		...
		String pl = VelocityServerUtil.getPlayerList();
		if(pl == "") pl = VelocityMinecraftDiscordSync.getInstance().getPluginMessages().translate("command.discord.playerlist.noplayers");
