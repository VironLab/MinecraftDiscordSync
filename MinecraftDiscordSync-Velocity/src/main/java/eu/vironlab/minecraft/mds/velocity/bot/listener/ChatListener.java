...
public class ChatListener extends ListenerAdapter {
	...
	public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
		...
		String messageFormat = VelocityMinecraftDiscordSync.getInstance().getConfig().getString("format.ingamechat", "[%pluginprefix%] » %playername% » %message%");
		...
		VelocityServerUtil.broadcastMessage(messageToSend);
