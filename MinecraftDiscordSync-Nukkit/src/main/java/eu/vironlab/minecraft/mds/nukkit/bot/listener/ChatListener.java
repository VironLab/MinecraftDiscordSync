...
public class ChatListener extends ListenerAdapter {
	...
	public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
		...
		String messageFormat = NukkitMinecraftDiscordSync.getInstance().getConfig().getString("format.ingamechat", "[%pluginprefix%] » %playername% » %message%");
		...
		NukkitServerUtil.broadcastMessage(messageToSend);
