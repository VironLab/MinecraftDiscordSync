...
package eu.vironlab.minecraft.mds.nukkit.storage;
...
public class YAMLStorage implements IStorageProvider {
	...
	public YAMLStorage(Plugin plugin) {
		config = new Config(new File(plugin.getDataFolder(), "storage.yml"), Config.YAML);
	...
	public boolean removeVerifiedUser(String discordID) {
		for (String key : config.getSection(collectionRoot).keySet()) {
