...
public class OnlineCommand extends DiscordCommand {
	...
	public boolean execute(CommandData data) {
		...
		embedBuilder.setTitle(NukkitMinecraftDiscordSync.getInstance().getPluginMessages().translate("command.discord.online.title", String.valueOf(NukkitServerUtil.getPlayerCount()), String.valueOf(NukkitServerUtil.getMaxPlayerCount())));
